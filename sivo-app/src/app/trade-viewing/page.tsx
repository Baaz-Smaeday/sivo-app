      ...
      <section style={{ padding: '48px 0 64px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 20px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 20, marginTop: 32 }}>
            {/* Virtual Viewing */}
            <div style={{ padding: 32, background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 8, boxShadow: '0 0 30px rgba(201,169,110,.05)' }}>
            ...
            <div style={{ padding: 32, background: 'var(--card)', border: '1px solid rgba(201,169,110,.2)', borderRadius: 8, boxShadow: '0 0 30px rgba(201,169,110,.05)', position: 'relative' }}>
              <div style={{ marginBottom: 16 }}>
          ...
          {/* How It Works */}
          <div style={{ padding: 32, marginTop: 32, background: 'linear-gradient(135deg, rgba(201,169,110,.03), transparent)', border: '1px solid var(--border)', borderRadius: 8 }}>
          ...
          {/* What We Bring */}
          <div style={{ padding: 32, marginTop: 16, background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 8 }}>
