  ...
  return (
    <div className="pt-[60px]">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 -mt-5 relative z-[5]">
        <div className="card card-glow shimmer p-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-3" style={{ borderColor: 'rgba(255,167,38,.15)' }}>
      ...
      <section className="section" style={{ background: 'linear-gradient(140deg, var(--navy), var(--dark))' }}>
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="space-y-2 mb-5">
                {['UK-held hero samples across collections', 'Sample fee credited against first production order', 'Personal delivery to your store on request'].map(t => (
                  <div key={t} className="card card-glow shimmer p-3.5" style={{ borderLeft: '3px solid var(--gold)' }}>
            ...
            <div className="card card-glow shimmer p-8 text-center" style={{ background: 'linear-gradient(135deg, rgba(201,169,110,.04), transparent)' }}>
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div key={s.t} className="card card-glow shimmer p-6 text-center">
