    ...
    <div className="pt-[80px]">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 pb-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="card card-glow shimmer p-8">
          ...
          <div className="card card-glow shimmer p-8" style={{ borderColor: 'rgba(201,169,110,.3)' }}>
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={s.t} className="card card-glow shimmer p-6">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.title} className="card card-glow shimmer p-6 text-center card-glow">
