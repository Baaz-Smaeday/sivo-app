  ...
  return (
    <div>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 py-16 text-center">
        <div className="text-[10px] font-semibold tracking-[3px] uppercase text-brand-gold mb-4">Why SIVO</div>
        <h1 className="font-serif text-4xl sm:text-5xl text-white mb-6">The Smarter Way to Source Furniture</h1>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 pb-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="card p-8 border-brand-gold/30">
            <h2 className="font-serif text-2xl text-brand-gold mb-4">The SIVO Way</h2>
            <div className="space-y-3 text-sm text-brand-text leading-relaxed">
      ...
      <section className="bg-brand-surface border-y border-brand-border py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <div className="text-[10px] font-semibold tracking-[3px] uppercase text-brand-gold mb-3">Our Process</div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={item.step} className="text-center">
                <div className="text-3xl font-serif text-brand-gold mb-3">{item.step}</div>
      ...
      <section className="bg-brand-surface border-y border-brand-border py-16">
        <div className="max-w-2xl mx-auto text-center px-4">
          ...
          <p className="text-brand-muted mb-8">Apply for a trade account and start sourcing at genuine wholesale prices.</p>
