      ...
      <section className="section">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-8">
            {materials.map(m => (
              <div key={m.name} className="card card-glow shimmer p-0 overflow-hidden">
                <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr]">
                  ...
                  <div className="p-6 sm:p-8">
                    ...
                    <a href={`/catalog?material=${encodeURIComponent(m.name)}`}
                      className="inline-flex items-center gap-2 px-5 py-2.5 border border-[var(--border)] rounded text-[10px] font-semibold tracking-[1.5px] uppercase text-[var(--muted)] hover:border-[var(--gold)] hover:text-[var(--gold)] transition-all">
