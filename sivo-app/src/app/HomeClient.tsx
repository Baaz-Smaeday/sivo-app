          ...
          {[
            ...
            item.href ? (
              <Link key={item.label} href={item.href}
                    className="card card-glow p-4 flex-1 min-w-[140px] text-center cursor-pointer">
                <div className="text-lg mb-1">{item.icon}</div>
                <div className="text-[11px] text-[var(--gold)]">{item.label}</div>
              </Link>
            ) : (
              <div key={item.label} className="card card-glow p-4 flex-1 min-w-[140px] text-center">
                <div className="text-lg mb-1">{item.icon}</div>
                <div className="text-[11px] text-[var(--gold)]">{item.label}</div>
